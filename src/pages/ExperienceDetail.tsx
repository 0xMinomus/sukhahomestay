...
export default function ExperienceDetail() {
  ...
  return (
    <>
      <Hero
        img={experience.img}
        eyebrow={`${experience.index} / ${experience.overviewLabel}`}
        ...
        <div className="mx-auto grid max-w-[1440px] grid-cols-1 items-center gap-10 px-6 py-20 md:grid-cols-2 md:gap-20 md:px-[120px] md:py-28">
          ...
          <Reveal delay={0.1}>
            <p className="max-w-md text-[16px] leading-[26px] text-stone md:justify-self-end">
              Ask about the landscape, the pace, and what you would like to understand. {experience.hostConfirmation}
            </p>
          </Reveal>
        </div>
      </section>
      ...
      {experience.facts && (
        <section className="bg-cream">
          <div className="mx-auto max-w-[1440px] px-6 py-20 md:px-[120px] md:py-24">
            ...
            <Stagger className="mt-10 grid grid-cols-2 gap-px border-t border-line bg-line md:grid-cols-4">
